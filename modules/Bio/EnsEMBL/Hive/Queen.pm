...
sub create_new_worker {
    ...
    my ($preregistered, $resource_class_id, $resource_class_name, $beekeeper_id,
            $no_write, $debug, $worker_base_tmp_dir, $worker_log_dir, $hive_log_dir, $job_limit, $life_span, $no_cleanup, $retry_throwing_jobs, $can_respecialize,
    ...
    $worker->base_tmp_dir( $worker_base_tmp_dir );
